...
public abstract class GloboNetworkCommand extends Command {

    private static final Logger s_logger = Logger.getLogger(GloboNetworkCommand.class);

    public abstract Answer execute(GloboNetworkAPI gnetAPI);
