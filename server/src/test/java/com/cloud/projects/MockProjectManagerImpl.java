...
public class MockProjectManagerImpl extends ManagerBase implements ProjectManager {
    ...
    @Override
    public Project createProject(String name, String displayText, String accountName, Long domainId, String businessServiceId, String clientId, String componentId, String subComponentId, String productId, Boolean detailedUsage) throws ResourceAllocationException {
    ...
    @Override
    public Project updateProject(long id, String displayText, String newOwnerName, String businessServiceId, String clientId, String componentId, String subComponentId, String productId, Boolean detailedUsage) throws ResourceAllocationException {
        // TODO Auto-generated method stub
        return null;
    }
