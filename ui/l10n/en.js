...
"label.action.link.loadbalancer.processing": "Linking Load Balancer",
"label.action.link.loadbalancer": "Link Load Balancer",
...
"label.action.unlink.loadbalancer.processing": "Unlinking load balancer...",
"label.action.unlink.loadbalancer": "Unlink load balancer",
"label.add.globo.aclapi": "Add Globo ACL API",
"label.add.globo.dns": "Add GloboDNS",
"label.fqdn": "FQDN",
"label.globo.aclapi.configuration": "Globo ACL API Configuration",
"label.globo.aclapi": "Globo ACL API",
"label.globo.dns.configuration": "GloboDNS Configuration",
"label.globo.dns": "GloboDNS",
...
"label.lb.algorithm.roundrobin": "Round-robin",
"label.lb.algorithm.source": "Source",
"label.max.hosts.supported": "Max hosts supported",
"label.project.businessservice": "Business Service",
"label.project.client": "Client",
"label.project.component": "Component",
"label.project.detailedusage": "Detailed Usage",
"label.project.product": "Product",
"label.project.subcomponent": "Sub-component",
"label.scale.logicaloperator": "Logical Operator",
"label.scaledown.step": "Scale down step",
"label.scaleup.step": "Scale up step",
"label.vm.ip": "VM IP Address",
"message.action.link.loadbalancer": "Link Load balancer with another lb will destroy pools and associate lb with second lb\\'s pools. This operation needs to redeploy VIP. Are you sure want to link load balancer?",
"message.action.unlink.loadbalancer": "Unlink Load balancer from another will remove pools and create new ones. This operation needs to redeploy VIP. Are you sure want to unlink load balancer?",
